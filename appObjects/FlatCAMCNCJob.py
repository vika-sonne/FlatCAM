				...
				try:
					for sh in geometry:
						if custom_color is None:
							self.add_probing_shape(shape=sh, color=edge_color, face_color=get_rand_fg_color(self.app), visible=True)
						else:
							self.add_probing_shape(shape=sh, color=custom_color, face_color=custom_color, visible=True)
				except TypeError:
					if custom_color is None:
						self.add_probing_shape(
							shape=geometry, color=edge_color, face_color=get_rand_fg_color(self.app), visible=True)
					else:
						self.add_probing_shape(
